			...
			<div class="card p-3 mt-2">
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<div class="user d-flex flex-row align-items-center">
						...
						<img src="https://i.imgur.com/0LKZQYM.jpg" width="30"
							class="user-img rounded-circle mr-2"> <span><small
							class="font-weight-bold text-primary">rashida_jones</small> <small
							class="font-weight-bold">Really cool Which filter are you
								using? </small></span>
				...
				<div
					...
					<div class="icons align-items-center">
						<i class="fa fa-user-plus text-muted"></i> <i
			...
			<div class="card p-3 mt-2">
				...
				<div class="d-flex justify-content-between align-items-center">
					...
					<div class="user d-flex flex-row align-items-center">
						...
						<img src="https://i.imgur.com/ZSkeqnd.jpg" width="30"
							class="user-img rounded-circle mr-2"> <span><small
