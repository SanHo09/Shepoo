...
<nav class="navbar navbar-light bg-light navbar-expand-lg"
	id="shopeeNavCenter" style="background-color: #ffffff !important;">
	<div class="container">
		<div class="col-sm-5">
            ...
            </svg> <span style="font-size: 25px;">Shepoo <span
					style="font-weight: 350; font-size: 20px;"> | Giỏ hàng</span>
			</span>
		...
		<div class="col-sm-6">
			<div class=" input-group">
				<input id="findMoreProduct" type="text" class="form-control"
					placeholder="TÌM THÊM HÀNG " aria-label="Recipient's username"
					aria-describedby="button-addon2">
				<button class="btn" type="button" id="button-addon2"
					style="border: 1px solid #f94e30; background-color: #f94e30; width: 100px;">
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
