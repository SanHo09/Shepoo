		...
		<div class="row">
				...
				<div id="carouselExampleIndicators" class="carousel slide"
					...
					<div class="carousel-inner">
						...
						<div class="carousel-item">
							<img src="/images/banner/banner_classify6.png"
			...
			<div class="col-sm-5">
				<div class="row banner-top">
					<img src="/images/banner/banner_top.jpg" width="100%"
						height="125px" alt=""> <img
						src="/images/banner/banner_bottom.jpg" width="100%" height="125px"
						srcset="">
				</div>
			</div>
...
<br>
<!--category-->
<div class="container justify-content-center category"
