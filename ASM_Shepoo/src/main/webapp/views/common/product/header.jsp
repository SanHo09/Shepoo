			...
			<span class="navbar-text">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <path
					...
					<li class="nav-item" ng-if="user!=''"><a class="nav-link" href="/user/signIn"
						aria-current="page" href="#!signIn"> <svg 
								xmlns="http://www.w3.org/2000/svg" width="16" height="16"
...
<nav class="navbar navbar-light bg-light navbar-expand-lg"
	id="shopeeNavCenter" style="background-color: #f94e30 !important;">
	<div class="container">
		<div class="col-sm-3">
			<a class="navbar-brand" href="#"> <svg
					xmlns="http://www.w3.org/2000/svg" width="50" height="50"
					fill="currentColor" style="margin-bottom: 20px;"
					class="bi bi-bag-check-fill" viewBox="0 0 16 16">
            <path fill-rule="evenodd"
						d="M10.5 3.5a2.5 2.5 0 0 0-5 0V4h5v-.5zm1 0V4H15v10a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V4h3.5v-.5a3.5 3.5 0 1 1 7 0zm-.646 5.354a.5.5 0 0 0-.708-.708L7.5 10.793 6.354 9.646a.5.5 0 1 0-.708.708l1.5 1.5a.5.5 0 0 0 .708 0l3-3z" />
          </svg> <span style="font-size: 30px;">Shepoo</span>

			</a>
		</div>
		<div class="col-sm-6">
			<div class=" input-group">
				<input type="text" class="form-control" ng-model="prodName"
					ng-keyup="findProd()" placeholder="FREESHIP ĐẾN 0K"
		...
		<div class="col-sm-3">
			<svg style="margin-left: 50px;" xmlns="http://www.w3.org/2000/svg"
				width="30" height="30" fill="white" class="bi bi-cart"
				viewBox="0 0 16 16">
          <path
